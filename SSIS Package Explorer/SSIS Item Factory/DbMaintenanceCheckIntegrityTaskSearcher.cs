...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class DbMaintenanceCheckIntegrityTaskSearcher:ISSISItem
    {
        string currentItemType = "Check Database Integrity Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DbMaintenanceCheckIntegrityTask DbMaintenanceCheckIntegrityTask = (DbMaintenanceCheckIntegrityTask)hostedTask.InnerObject;
