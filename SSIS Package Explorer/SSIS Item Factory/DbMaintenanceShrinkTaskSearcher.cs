...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class DbMaintenanceShrinkTaskSearcher:ISSISItem
    {
        string currentItemType = "Shrink Database Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DbMaintenanceShrinkTask DbMaintenanceShrinkTask = (DbMaintenanceShrinkTask)hostedTask.InnerObject;
            ...
            SSISItems.AddRange(SearchPattern(searchPattern, DbMaintenanceShrinkTask, hostedTask, packageData));

            return SSISItems;
        }

        private List<PackageItem> SearchPattern(string searchPattern, DbMaintenanceShrinkTask task, TaskHost hostedTask, PackageInfo packageData)
        {
            List<PackageItem> SSISItems = new List<PackageItem>();
