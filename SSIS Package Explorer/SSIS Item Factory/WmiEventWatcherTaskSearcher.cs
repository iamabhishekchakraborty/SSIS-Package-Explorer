...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class WmiEventWatcherTaskSearcher:ISSISItem
    {
        string currentItemType = "WMI Event Watcher Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            WmiEventWatcherTask wmiEventWatcherTask = (WmiEventWatcherTask)hostedTask.InnerObject;
            ...
            SSISItems.AddRange(SearchPattern(searchPattern, wmiEventWatcherTask, hostedTask, packageData));

            return SSISItems;
        }

        private List<PackageItem> SearchPattern(string searchPattern, WmiEventWatcherTask task, TaskHost hostedTask, PackageInfo packageData)
        {
            List<PackageItem> SSISItems = new List<PackageItem>();
