...
{
    //For Loop Container
    public class ForLoopSearcher: ISSISItem
    {
        string currentItemType = "For Loop Container";
        ...
        {
            Executable forLoopContainer = (Executable)executable;

            List<PackageItem> packageItems = new List<PackageItem>();

            ForLoop container = ((ForLoop)forLoopContainer);
