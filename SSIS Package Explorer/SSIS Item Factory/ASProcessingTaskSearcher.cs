...
{
    //Code for Analysis Services Processing Task
    public class ASProcessingTaskSearcher: ISSISItem
    {
        string currentItemType = "Analysis Services Processing Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DTSProcessingTask ASProcessingTask = (DTSProcessingTask)hostedTask.InnerObject;
