...
{
    //Data Profiling Task
    public class DataProfilingTaskSearcher:ISSISItem
    {
        string currentItemType = "Data Profiling Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DataProfilingTask dataProfilingTask = (DataProfilingTask)hostedTask.InnerObject;
