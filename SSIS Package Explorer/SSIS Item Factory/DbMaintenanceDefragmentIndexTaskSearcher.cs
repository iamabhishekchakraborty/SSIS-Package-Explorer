...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class DbMaintenanceDefragmentIndexTaskSearcher:ISSISItem
    {
        string currentItemType = "Reorganize Index Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DbMaintenanceDefragmentIndexTask DbMaintenanceDefragmentIndexTask = (DbMaintenanceDefragmentIndexTask)hostedTask.InnerObject;
            ...
            SSISItems.AddRange(SearchPattern(searchPattern, DbMaintenanceDefragmentIndexTask, hostedTask, packageData));

            return SSISItems;
        }

        private List<PackageItem> SearchPattern(string searchPattern, DbMaintenanceDefragmentIndexTask task, TaskHost hostedTask, PackageInfo packageData)
        {
            List<PackageItem> SSISItems = new List<PackageItem>();
