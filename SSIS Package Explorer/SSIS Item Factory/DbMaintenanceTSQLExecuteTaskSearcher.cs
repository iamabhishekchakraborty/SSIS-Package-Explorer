...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class DbMaintenanceTSQLExecuteTaskSearcher:ISSISItem
    {
        string currentItemType = "Execute T-SQL Statement Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            DbMaintenanceTSQLExecuteTask DbMaintenanceTSQLExecuteTask = (DbMaintenanceTSQLExecuteTask)hostedTask.InnerObject;
            ...
            SSISItems.AddRange(SearchPattern(searchPattern, DbMaintenanceTSQLExecuteTask, hostedTask, packageData));

            return SSISItems;
        }

        private List<PackageItem> SearchPattern(string searchPattern, DbMaintenanceTSQLExecuteTask task, TaskHost hostedTask, PackageInfo packageData)
        {
            List<PackageItem> SSISItems = new List<PackageItem>();
