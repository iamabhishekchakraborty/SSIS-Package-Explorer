...
namespace SSIS_Package_Reader.SSIS_Item_Factory
{
    ...
    public class TransferErrorMessagesTaskSearcher : ISSISItem
    {
        string currentItemType = "Transfer Error Messages Task";
        ...
        public List<PackageItem> Search(string searchPattern, object executable, PackageInfo packageData, string parentName = "", string parentType = "")
        {
            ...
            TransferErrorMessagesTask transferErrorMessagesTask = (TransferErrorMessagesTask)hostedTask.InnerObject;
